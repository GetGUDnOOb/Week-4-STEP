public class SmartDevice {
    ...
    public SmartDevice(String deviceName, String location,
        ...
        // Use this keyword to distinguish between fields and parameters
        this.deviceName = deviceName;
        this.location = location;
        this.isOnline = isOnline;
        this.powerConsumption = powerConsumption;
        this.connectedDevices = new String[5]; // size 5
    ...
    public static void main(String[] args) {
        ...
        // Create a device with parameters matching field names
        SmartDevice device = new SmartDevice("Living Room Speaker", "Living Room", false, 15.5);

        // Demonstrate parameter disambiguation and this keyword
        device.updateLocation("Living Room Shelf");
        device.updatePowerConsumption(20.0);

        // Demonstrate method chaining using returned this
        ...
        // Perform initial setup using this to call other methods
        device.performInitialSetup();

        // Chain more methods to test connection limit
        device.connectToDevice("Smart Light")
              .connectToDevice("Smart Thermostat")
              .connectToDevice("Security Camera") // Should reach limit here
              .connectToDevice("Extra Device");   // Exceeding limit test
